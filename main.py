...
def main():
    ...
    if args.ksm:
        ...
        ref_dict = torch.load("./save/resnet50_CL_params/cubs_cropped/resnet50_pretrained/pretrained_model.pth.tar")
        ft_dict = torch.load(f"./save/resnet50_CL_params/{args.dataset}/resnet50_finetuned/finetuned_model.pth.tar")
        rp_energy = est.finetune_reprogram_energy(ref_dict["state_dict"], ft_dict["state_dict"], cell_specs=cell_specs)
    else:
        sparsity = sparsity_all[args.dataset] / 100
